...
const purpose = [
	{
		...
		type: 'list',
		name: 'menu',
		choices: ['View All Employees', 'Add Employee', 'Update Employee Role', 'View All Roles', 'Add Role',  'View All Departments', 'Add Department', 'Quit', 'View Employees by Manager', 'View Employees by Department', 'Update Employee Managers', 'Delete departments, roles, and employees', 'View the total utilized budget of a department',]
	}
];	
